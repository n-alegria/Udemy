...
START TRANSACTION;
USE `bienesraices_crud`;
INSERT INTO `bienesraices_crud`.`vendedores` (`id`, `nombre`, `apellido`, `telefono`) VALUES (1, 'Juan', 'De La Torre', '13841991');
INSERT INTO `bienesraices_crud`.`vendedores` (`id`, `nombre`, `apellido`, `telefono`) VALUES (2, 'Karen', 'Perez', '13131313');
